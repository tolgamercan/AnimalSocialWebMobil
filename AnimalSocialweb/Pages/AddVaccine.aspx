        ...
        <div class="row" id="ProcessPanel">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <select class="form-control" id="VaccineDropDown" name="VaccineDropDown" data-rule-min="1" required="required">
                        
                    </select>
                    <button type="button" id="VaccineAddButton" class="btn btn-success" ><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></button>
